...
class calculate_sales {
	...
	public static void main(String[]args){
		...
		try{
			...
			System.out.println("1予期せぬエラーが発生しました。");
			return;
		}finally{
			if(br !=null)
				try{
		...
		try{
			...
			System.out.println("2予期せぬエラーが発生しました。");
			return;
		}finally{
			if(br != null)
				try{
		...
		for(int i = 0; i<rcdfiles.size(); i++){
			try{
				...
				System.out.println("3予期せぬエラーが発生しました。");
				return;
			}
		}
...
//		branch.outに書き込み
		...
		try{
			...
			System.out.println("4予期せぬエラーが発生しました。");
			return;
		}finally{
		...
		try{
			...
			System.out.println("5予期せぬエラーが発生しました。");
			return;
		}finally{
			if(bw !=null)
				try{
